...
{pre_text}"""
    ...
    def _generate_background(self, npc_data: NpcData, now: GameTime) -> str:
        ...
        p.sentence(f"Ты {sex("родился", "родилась")} {born_in} {age} лет назад, {birthday}.")
        ...
        q2 = ["агрессивно", "немногословно", "многословно", "спокойно", "грубо", "прямо",
              "изысканно", "выспренно", "прямо и грубо", "хлестко и уверенно",
              "кратко", "путая слова и падежи",
              "короткими стихами как герои пьесы Шекспира", "короткими хлесткими рифмованными фразами",
              "солдатским смачным матом и подколками",
              "короткими матерными частушками"]
